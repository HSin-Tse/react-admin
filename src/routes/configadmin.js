export default {
    menus: [ // 菜单相关路由
        ...
        },
        {
            ...
            subs: [
                {tk:'SERVICE_GROUP_MGMT',key: '/app/customer/PotentialUser', title: 'Leads管理', component: 'PotentialUser'},
                {tk:'SERVICE_GROUP_MGMT',key: '/app/customer/CustomerSummary', title: '用户总表', component: 'CustomerSummary'},
        ...
        },
        {
            ...
            subs: [
                {tk:'SERVICE_GROUP_MGMT',key: '/app/pass/open', title: '开户审核', component: 'PassOpen'},
